...
*/
   @PostMapping("/participate/{formationId}/{userId}")
   public ResponseEntity<?> participateFormation(@PathVariable Long formationId, @PathVariable Integer userId) {
       try {
           Formation participatedFormation = iformationService.participateInFormation(formationId, userId);
           return ResponseEntity.ok(participatedFormation);
